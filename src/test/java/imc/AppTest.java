    ...
    extends TestCase
{
    ...
    public void testaImc()
    {
      ...
      Pessoa Fulana = new Mulher ("Fulana", "Barbosa" , 15,60.0, 1.70);
      assertEquals(60.0 / (1.70*1.70), Fulana.GetImc());

      // TO DO: complementar o teste com objetos da classe mulher OK!!!!!!!!!!
    ...
    public void testaClassificacao()
    {
      ...
      Pessoa Fulana = new Mulher ("Fulana" , "Barbosa" , 15 , 70.0 , 1.70);
      assertEquals("abaixo do peso", Fulana.GetClassificacao());
